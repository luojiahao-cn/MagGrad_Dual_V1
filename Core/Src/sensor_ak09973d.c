...
// AK09973D I2C address (7-bit, same for all)
...
// 12 AK09973D instances: 6 on I2C1 + 6 on I2C2
...
// Read one AK09973D and format as CSV line
...
// Read all initialized AK09973D sensors and send CSV output
